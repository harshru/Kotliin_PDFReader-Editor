...
import testkotliin.pdfreader.pdfeditor.Adapter.AdapterTools;
...
public class ActivityPDFTools extends AppCompatActivity implements AdapterTools.OnSelectedMenuClickListener {
    ...
    public void onCreate(Bundle bundle) {
        ...
        AppManage.getInstance(ActivityPDFTools.this).showBanner(ll_banner, AppManage.ADMOB_B[0], AppManage.FACEBOOK_B[0]);
        AppManage.getInstance(ActivityPDFTools.this).showNative(fl_native, AppManage.ADMOB_N[0], AppManage.FACEBOOK_N[0]);
