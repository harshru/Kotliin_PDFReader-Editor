...
import testkotliin.pdfreader.pdfeditor.Adapter.AdapterMergeOrganalPDF;
...
public class ActivityOrganizeMergePDF extends AppCompatActivity {
    ...
    public void onCreate(Bundle bundle) {
        ...
        AppManage.getInstance(ActivityOrganizeMergePDF.this).showBanner(ll_banner, AppManage.ADMOB_B[0], AppManage.FACEBOOK_B[0]);
        AppManage.getInstance(ActivityOrganizeMergePDF.this).showNative(fl_native, AppManage.ADMOB_N[0], AppManage.FACEBOOK_N[0]);
