...
import testkotliin.pdfreader.pdfeditor.Adapter.AdapterOrganizePages;
import testkotliin.pdfreader.pdfeditor.GetSet.PDFPage;
...
public class ActivityOrganizePages extends AppCompatActivity {
    ...
    public void onCreate(Bundle bundle) {
        ...
        AppManage.getInstance(ActivityOrganizePages.this).showBanner(ll_banner, AppManage.ADMOB_B[0], AppManage.FACEBOOK_B[0]);
        AppManage.getInstance(ActivityOrganizePages.this).showNative(fl_native, AppManage.ADMOB_N[0], AppManage.FACEBOOK_N[0]);
    ...
    public class SaveOrganizedPages extends AsyncTask<Void, Integer, Void> {
        ...
        public void onPostExecute(Void r5) {
            ...
            AppManage.getInstance(ActivityOrganizePages.this).showInterstitialAd(ActivityOrganizePages.this, () -> {
