...
import testkotliin.pdfreader.pdfeditor.Adapter.AdapterExtractTextsPages;
...
public class ActivityExtractTextsPages extends AppCompatActivity {
    ...
    public void onCreate(Bundle bundle) {
        ...
        AppManage.getInstance(ActivityExtractTextsPages.this).showBanner(ll_banner, AppManage.ADMOB_B[0], AppManage.FACEBOOK_B[0]);
        AppManage.getInstance(ActivityExtractTextsPages.this).showNative(fl_native, AppManage.ADMOB_N[0], AppManage.FACEBOOK_N[0]);
