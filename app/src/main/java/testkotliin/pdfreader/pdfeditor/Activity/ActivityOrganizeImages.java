...
import testkotliin.pdfreader.pdfeditor.Adapter.AdapterOrganizeImages;
import testkotliin.pdfreader.pdfeditor.GetSet.ImagePage;
import testkotliin.pdfreader.pdfeditor.utils.ImageUtils;
...
public class ActivityOrganizeImages extends AppCompatActivity {
    ...
    public void onCreate(Bundle bundle) {
        ...
        AppManage.getInstance(ActivityOrganizeImages.this).showBanner(ll_banner, AppManage.ADMOB_B[0], AppManage.FACEBOOK_B[0]);
        AppManage.getInstance(ActivityOrganizeImages.this).showNative(fl_native, AppManage.ADMOB_N[0], AppManage.FACEBOOK_N[0]);
    ...
    public void OpenImagePathSet(final Context context2, String str, final String str2, final boolean z) {
        ...
        btnOpenPdfFile.setOnClickListener(view -> {
            if (z) {
                AppManage.getInstance(ActivityOrganizeImages.this).showInterstitialAd(ActivityOrganizeImages.this, () -> {
