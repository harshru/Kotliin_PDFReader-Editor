...
public class AdapterTools extends RecyclerView.Adapter<AdapterTools.ToolsViewHolder> {
    public Context mContext;
    public OnSelectedMenuClickListener toolClickListener;
    public List<Tool> tools;

    public AdapterTools(Context context, List<Tool> list) {
        this.tools = list;
    ...
    public void onBindViewHolder(final ToolsViewHolder toolsViewHolder, int i) {
        ...
        toolsViewHolder.layToolItem.setOnClickListener(view -> AdapterTools.this.menuToolClick(toolsViewHolder.getAdapterPosition()));
    }
