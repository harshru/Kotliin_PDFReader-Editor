...
public class AdapterViewImages extends RecyclerView.Adapter<AdapterViewImages.ViewImagesViewHolder> {
    ...
    public void onBindViewHolder(ViewImagesViewHolder viewImagesViewHolder, int i) {
        ...
        viewImagesViewHolder.imgMainPic.setOnClickListener(new View.OnClickListener() {
            /* class testkotliin.pdfreader.pdfeditor.adapters.ViewImagesAdapter.AnonymousClass1 */
    ...
    public void removeImagePdfItems(List<Integer> list) {
        Collections.sort(list, new Comparator<Integer>() {
            /* class testkotliin.pdfreader.pdfeditor.adapters.ViewImagesAdapter.AnonymousClass2 */
    ...
    private class ActionModeCallback implements ActionMode.Callback {
        ...
        public boolean onCreateActionMode(ActionMode actionMode, Menu menu) {
            ...
            if (i >= 21) {
                ...
                ofObject.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
                    /* class testkotliin.pdfreader.pdfeditor.adapters.ViewImagesAdapter.ActionModeCallback.AnonymousClass1 */
        ...
        public void onDestroyActionMode(ActionMode actionMode) {
            ...
            if (i >= 21) {
                ...
                ofObject.setDuration(300L);
                ofObject.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
                    /* class testkotliin.pdfreader.pdfeditor.adapters.ViewImagesAdapter.ActionModeCallback.AnonymousClass2 */
