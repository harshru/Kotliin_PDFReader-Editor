...
public class AdapterShareAsPicture extends RecyclerView.Adapter<AdapterShareAsPicture.OrganizePagesViewHolder> {
    ...
    public void onBindViewHolder(final OrganizePagesViewHolder organizePagesViewHolder, int i) {
        ...
        organizePagesViewHolder.rLayMain.setOnClickListener(new View.OnClickListener() {
            /* class testkotliin.pdfreader.pdfeditor.adapters.ShareAsPictureAdapter.AnonymousClass1 */
    ...
    public void deletePhotoPdfItem(List<Integer> list) {
        Collections.sort(list, new Comparator<Integer>() {
            /* class testkotliin.pdfreader.pdfeditor.adapters.ShareAsPictureAdapter.AnonymousClass2 */
    ...
    private class ActionModeCallback implements ActionMode.Callback {
        ...
        public boolean onCreateActionMode(ActionMode actionMode, Menu menu) {
            ...
            if (i >= 21) {
                ...
                ofObject.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
                    /* class testkotliin.pdfreader.pdfeditor.adapters.ShareAsPictureAdapter.ActionModeCallback.AnonymousClass1 */
        ...
        public void onDestroyActionMode(ActionMode actionMode) {
            ...
            if (i >= 21) {
                ...
                ofObject.setDuration(300L);
                ofObject.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
                    /* class testkotliin.pdfreader.pdfeditor.adapters.ShareAsPictureAdapter.ActionModeCallback.AnonymousClass2 */
